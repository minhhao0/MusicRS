...
app = FastAPI(
    ...
    description="Recommend artists based on user genre preferences (collaborative + case-based filtering)",
    version="1.0.0",
)

app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],      # đổi thành domain cụ thể khi deploy, vd: ["http://localhost:3000"]
