...
<div className="flex gap-3 mt-4 w-full md:w-auto">
<button className="flex-1 md:flex-none flex items-center justify-center gap-2 rounded-full px-8 py-3 bg-primary text-slate-900 text-sm font-bold transition-transform active:scale-95">
<span>Edit Profile</span>
</button>
<button className="flex items-center justify-center rounded-full size-11 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
<span className="material-symbols-outlined">more_horiz</span>
</button>
</div>
</div>
...
<section className="flex flex-col gap-6 mt-8">
<div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
<h3 className="text-slate-900 dark:text-white text-xl font-bold">Bài hát thịnh hành</h3>
<button className="text-slate-400 text-sm font-bold hover:text-slate-100">Show all</button>
</div>
{/* <!-- Tab Content: Recently Played (Grid) --> */}
<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
{/* <!-- Card 1 --> */}
<div className="group flex flex-col gap-3 p-4 rounded-xl bg-slate-800/20 hover:bg-slate-800/40 transition-all cursor-pointer" data-nav-type="song" data-id="midnight-city">
<div className="relative aspect-square overflow-hidden rounded-lg shadow-lg">
